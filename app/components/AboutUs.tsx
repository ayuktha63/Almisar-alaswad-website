...
const AboutUs: React.FC = () => {
  return (
    <section className="flex flex-col md:flex-row justify-center items-center gap-10 md:gap-36 py-20 bg-white w-full px-4 md:px-0">
      {/* Left Card */}
      <div className="flex flex-col items-center gap-4 w-full md:w-[277.5px]">
        <div className="w-full h-auto md:w-[277.5px] md:h-[196.5px] rounded-[22.5px] overflow-hidden">
          <Image
            src="/air-quality.svg"
        ...
        <p className="text-[#666] font-['Be Vietnam Pro'] text-[12px] font-normal leading-[150%] text-center w-full md:w-[277.5px]">
      ...
      {/* Right Content */}
      <div className="flex flex-col items-center md:items-start gap-4 w-full md:max-w-[348px] mt-10 md:mt-0">
        {/* Bullet + Heading */}
        ...
        {/* Description */}
        <p className="text-[20px] font-['Be Vietnam Pro'] font-normal leading-[150%] text-[rgba(0,0,0,0.9)] w-full md:w-[348px] md:pl-0 md:text-left text-center">
